...
- Add bolding to documentation ([@kelyvin](https://github.com/kelyvin))
- update cli documentation ([@kelyvin](https://github.com/kelyvin))
...
- make auto executable before calling ([@hipstersmoothie](https://github.com/hipstersmoothie))
- inject next version into bundled "auto" ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- enable canary releases for upload-assets plugin ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- chore: error cleanup and test coverage ([@lshadler](https://github.com/lshadler))
...
- mock octokit in cli tests ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- add error message around mistmatched auto versions ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- Bump command-line-application from 0.9.6 to 0.10.1 ([@dependabot-preview[bot]](https://github.com/dependabot-preview[bot]))
...
- make test clean up and not delete the zip files ([@hipstersmoothie](https://github.com/hipstersmoothie))
- add test that ensure bundled auto still works ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- align octokit types ([@hipstersmoothie](https://github.com/hipstersmoothie))
