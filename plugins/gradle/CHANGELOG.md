...
- [PLAYA-7576] - add canary identifier to canary release version, swapped order of flags to avoid breaking original use cases, added tests (tony_lin@intuit.com)
